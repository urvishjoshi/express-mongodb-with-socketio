...
window.infoToast = function infoToast(msg) {
  new (toastify_js__WEBPACK_IMPORTED_MODULE_2___default())({
    text: msg,
    newWindow: true,
    offset: {
      y: 60
...
var Order = orderInput ? orderInput.value : null;
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp == order.status) {
      ...
      if (status.nextElementSibling) {
        ...
        status.childNodes[1].innerText = moment__WEBPACK_IMPORTED_MODULE_0___default()(order.updatedAt).format('hh:mm A');
      }
    }
  });
}
...
if (currentUrl == '/admin/orders') {
  ...
  var ordersTableBody = document.querySelector('#ordersTableBody');
  var orders = [];
  var markup;
